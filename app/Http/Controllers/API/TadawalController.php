...
if(count($cobons) >= $cobon->number_use){
   return $this->apiResponse4(false, ' Cobons Not Avaliable', 400);
    ...
    $cap=round($request->card_price - 
    ($request->card_price * ($cobon->discount_percentage/100)),1);
}
...
*/
$cap= $this->checkcobon($request->client_id,$request->cobon_code,$request->card_id);
...
if(count($cobons) >= $cobon->number_use){
   return $this->apiResponse4(false, ' Cobons Not Avaliable', 400);
    ...
    $amount=$request->card_price - 
    ($request->card_price * ($cobon->discount_percentage/100));
}
...
$amount= $this->checkcobon($request->client_id,$request->cobon_code,$request->card_id);
