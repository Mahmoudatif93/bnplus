...
{{--
   ...
   @if (auth()->user()->hasPermission('read_users'))
    ...
    @if (auth()->user()->hasPermission('read_orders'))
            <li><a href="{{ route('dashboard.cobons.index') }}"><i class="fa fa-th"></i><span>@lang('site.cobons')</span></a></li>
        @endif
        
        
            @if (auth()->user()->hasPermission('read_orders'))
            <li><a href="{{ route('dashboard.packagessorders.index') }}"><i class="fa fa-th"></i><span>@lang('site.Packages_orders')</span></a></li>
        @endif

       @if (auth()->user()->hasPermission('read_orders'))
            <li><a href="{{ route('dashboard.Pacagesprofits.index') }}"><i class="fa fa-th"></i><span>@lang('site.Pacagesprofits')</span></a></li>
        @endif
        
             @if (auth()->user()->hasPermission('read_orders'))
            <li><a href="{{ route('dashboard.Catproducts.index') }}"><i class="fa fa-th"></i><span>@lang('site.Catproducts')</span></a></li>
        @endif
        
        
            @if (auth()->user()->hasPermission('read_orders'))
            <li><a href="{{ route('dashboard.Currsncyproducts.index') }}"><i class="fa fa-th"></i><span>@lang('site.Currsncyproducts')</span></a></li>
        @endif
        
              @if (auth()->user()->hasPermission('read_orders'))
            <li><a href="{{ route('dashboard.Newproducts.index') }}"><i class="fa fa-th"></i><span>@lang('site.Newproducts')</span></a></li>
        @endif
        
            @if (auth()->user()->hasPermission('read_orders'))
            <li><a href="{{ route('dashboard.ProductsCobons.index') }}"><i class="fa fa-th"></i><span>@lang('site.ProductsCobons')</span></a></li>
        @endif
        
            @if (auth()->user()->hasPermission('read_orders'))
            <li><a href="{{ route('dashboard.ProductsDelivery.index') }}"><i class="fa fa-th"></i><span>@lang('site.ProductsDelivery')</span></a></li>
        @endif
        
          @if (auth()->user()->hasPermission('read_orders'))
            <li><a href="{{ route('dashboard.ProductsReport.index') }}"><i class="fa fa-th"></i><span>@lang('site.ProductsReport')</span></a></li>
        @endif
        
         @if (auth()->user()->hasPermission('read_orders'))
            <li><a href="{{ route('dashboard.cardsreports.index') }}"><i class="fa fa-th"></i><span>@lang('site.cardsreports')</span></a></li>
        @endif
           @if (auth()->user()->hasPermission('read_orders'))
            <li><a href="{{ route('dashboard.productprofits.index') }}"><i class="fa fa-th"></i><span>@lang('site.productprofits')</span></a></li>
        @endif
