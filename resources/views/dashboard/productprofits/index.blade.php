...
<link href="https://cdn.datatables.net/1.10.21/css/jquery.dataTables.min.css" rel="stylesheet">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <h1>@lang('site.productprofits')
                <small> @lang('site.productprofits')</small>
            </h1>

            <ol class="breadcrumb">
                <li><a href="{{route('dashboard.index') }}"><i class="fa fa-dashboard"></i> @lang('site.dashboard')</a></li>
                <li class="active">@lang('site.productprofits')</li>
            </ol>
        </section>
                ...
                <div class="col-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-header">
                            ...
                            <h3 class="box-title" style="margin-bottom: 10px">@lang('site.productprofits')</h3>
                            
                            
                            <form action="{{ route('dashboard.productprofits.index') }}" method="get">
...
"><i class="fa fa-search"  ></i> @lang('site.search')</button>
 ...
 <?php  $delv=DB::select("select * from products_deliveries ");
 $delivery_fees=$delv[0]->delivery_fees;
 ?>
    ...
    @if (!empty($allprofits))
                        ...
                        <table class="table table-hover">
                            ...
                            <?php  $totals +=($category->total_price-$delivery_fees) - $category->total_price_before;?>
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    ...
                                    <td>{{ $category->paid }}</td>
                                     ...
                                     <td>{{ $delivery_fees }}</td>
                                      ...
                                      <td>{{ number_format($category->total_price-$delivery_fees,2) }}</td>
                                       <td>{{ number_format($category->total_price_before,2) }}</td>
                              <td>
                            
                                <button  class="btn btn-danger ">  {{number_format( ($category->total_price-$delivery_fees) - $category->total_price_before,2) }} 
                                    </button>
                                    </td>
  ...
  border-collapse: collapse;color='red' ;  background-color: #D6EEEE;">
                                     ...
                                     <th colspan="14"  >@lang('site.productprofits')</th>
    <th> <button  class="btn btn-primary ">  {{number_format( $totals,2) }}   </button></th>
    </tr>
